...
CREATE TABLE messages (
  ...
  private_chats_id INTEGER REFERENCES private_chats(id) ON DELETE CASCADE NOT NULL,
...
CREATE TABLE room_members (
  ...
  private_chats_id INTEGER REFERENCES private_chats(id) ON DELETE CASCADE
);

CREATE TABLE user_language (
  id SERIAL PRIMARY KEY NOT NULL,
  uset_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
  language_id INTEGER REFERENCES private_chats(id) ON DELETE CASCADE
);