    ...
    <div className="div_relative">
      ...
      <form action="/login" method="GET" id="form_registration">
        ...
        <input
          ...
          onChange={(e) => {
            console.log(e.target.value);
            if (e.target.value.length < 4) console.log("username should be longer than 4 chars")
        ...
        <input
          ...
          type="password"
          onChange={(e) => {
            if (e.target.value.length < 4) console.log("password should be longer than 4 chars")
            console.log(e.target.value);
        ...
        AVATAR :
        <ul>
          <input type="checkbox" id="man" value="M" onChange={(e) => {
            setUserAvatar(1)
          }}/>
          <label>M</label>
          <br />
          <input type="checkbox" id="woman" value="W" onChange={(e) => {
            setUserAvatar(2)
          }}/>
          <label>W</label>
          <br />
